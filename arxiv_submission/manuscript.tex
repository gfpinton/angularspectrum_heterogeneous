...
\cite{christopher1991,du1985,zemp2010} offers an attractive
alternative: by decomposing the field into plane-wave components and
applying the exact free-space propagator in wavenumber space via the
FFT, it avoids the paraxial approximation while remaining
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig1_focused_piston.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig2_attenuation_kk.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig3_shock_step_size.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig4_riemann.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\columnwidth]{fig5_boundary_profiles.png}
  \caption{Combined boundary with nonlinear propagation: final
    waveform (left) and spectrum (right) for four boundary
    configurations.  The interior waveform is invariant; harmonic
...
$\approx 1$; Strang+KT converges at rate $\approx 2$, consistent
with the expected second-order Strang splitting accuracy.

\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig6_convergence.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig7_transcranial_setup.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig8_transcranial_comparison.png}
...
specific to this FDTD configuration; it would need to be recalibrated
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig9_tips_setup.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig10_tips_comparison.png}
...
\url{https://github.com/gfpinton/angularspectrum_python} under the
LGPL v3 license.
